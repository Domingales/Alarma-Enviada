...
## Versión GPS-POP-v6-IPHONE-FORZADO-20260710

Correcciones añadidas:
- El botón “Autorizar GPS de este móvil” ahora muestra inmediatamente el estado “Solicitando GPS...” para que en iPhone no parezca que no hace nada.
- La petición GPS en iPhone usa primero una lectura normal, más fiable que alta precisión en interiores. Si tarda demasiado, hace un segundo intento.
- El receptor acepta cualquier alarma recibida dentro del mismo canal Firebase si no ha sido creada por él mismo, aunque el campo destino (`to`) tenga un DNI antiguo. Esto corrige fallos por caché, reinstalación o cambios de DNI local.
- La confirmación del receptor reescribe el destino remoto con el DNI actual del receptor para que el emisor pueda ver el check verde.

Nota para iPhone:
Si al pulsar el botón no aparece el aviso del sistema, abrir la app directamente en Safari o Chrome, no desde el navegador interno de WhatsApp, y revisar los permisos en Ajustes > Privacidad y seguridad > Localización.

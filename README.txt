ALARMAS LUCÍA
Versión: ALARMAS-LUCIA-v3.1-COMPROBACION-INMOVILIDAD-EMISOR-20260806
...
- La detección de inmovilidad continúa realizándose en el móvil RECEPTOR según
  el tiempo y la distancia configurados en AJUSTES.
- Al detectarse falta de movimiento, el RECEPTOR envía por Firebase una
  solicitud de comprobación al móvil EMISOR.
- En el EMISOR aparece una ventana prioritaria con el texto «¿VA TODO BIEN?
  Se ha detectado falta de movimiento» y dos botones grandes: SÍ (verde) y
  NO (rojo).
- Si el EMISOR tenía activo AHORRO DE ENERGÍA, la pantalla negra se retira
  automáticamente para mostrar la pregunta.
- Al responder SÍ, el RECEPTOR muestra «TRANQUILO, VA TODO BIEN.», la app
  continúa normalmente y el EMISOR recupera el ahorro de energía si estaba
  activo antes de la comprobación.
- Tras una respuesta SÍ se inicia un nuevo periodo completo de vigilancia. Si
  vuelve a transcurrir el tiempo configurado sin movimiento, se repite la
  comprobación.
- Al responder NO, el RECEPTOR muestra «¡ATENCIÓN! POSIBLE INCIDENCIA.», activa
  sonido de alarma, vibración y parpadeo de pantalla entre blanco y rojo.
- El botón SILENCIAR detiene el sonido, la vibración y el parpadeo.
- Cada detección utiliza un identificador único y queda bloqueada mientras está
  pendiente, evitando ventanas y respuestas duplicadas.

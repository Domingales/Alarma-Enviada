...
function upsertAlarm(alarm){
  ...
  if(i >= 0) state.alarms[i] = Object.assign({}, state.alarms[i], cleaned);
  else state.alarms.push(cleaned);
  saveAlarms();
}
...
function receiveOnlineAlarm(alarm){
  ...
  // Si el móvil receptor estaba sonando y llega una anulación/remarcado

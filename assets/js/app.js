...
function alarmCardHtml(a, compact){
  ...
  return `<div class="alarm-item ${a.status}"><strong>${dir}</strong><div>${when}</div><div><strong>Mensaje original:</strong> ${note}</div>${transition}${cancelMsg}${receivedMsg}${extra}${actions}</div>`;
}
